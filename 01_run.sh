...
#Summary statistics of raw fastq
...
#'Trim primer'
#cutadapt --revcomp -a AGCAAAAGCAGG...CCTTGTTTCTACT -m 800 -q 15 -o result/fastq/filtered_02.fq.gz result/fastq/filtered.fq.gz
